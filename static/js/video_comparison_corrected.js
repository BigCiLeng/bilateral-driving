// Corrected Video Comparison Functions
// Fixed aspect ratio and canvas sizing issues
...
function playVids(videoId) {
    ...
    let position = 0.5;
    const vidWidth = vid.videoWidth;  // Use full video width
    ...
    function drawLoop() {
        ...
        // Draw left side (first video) - use first half of the source video
        const halfWidth = vidWidth / 2;
        mergeContext.drawImage(vid, 0, 0, halfWidth, vidHeight, 0, 0, halfWidth, vidHeight);
        
        // Draw right side (second video) based on position - use second half of the source video
        const colStart = (halfWidth * position).clamp(0, halfWidth);
        const colWidth = (halfWidth - (halfWidth * position)).clamp(0, halfWidth);
        mergeContext.drawImage(vid, colStart + halfWidth, 0, colWidth, vidHeight, colStart, 0, colWidth, vidHeight);
        
        // Draw divider line
        const lineX = halfWidth * position;
